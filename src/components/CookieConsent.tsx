              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="flex items-start justify-between gap-4 pb-4 border-b">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Essenciais para o funcionamento adequado do site. Não podem ser desativados.
                    </p>
                  </div>
                  <div className="flex-shrink-0">
                ...
                <div className="flex items-start justify-between gap-4 pb-4 border-b">
                  <div className="flex-1">
                    <div className="font-medium mb-1">Cookies de Análise</div>
                    <p className="text-sm text-muted-foreground">
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1">
                    <div className="font-medium mb-1">Cookies de Marketing</div>
                    <p className="text-sm text-muted-foreground">
                      Utilizados para entregar anúncios personalizados relevantes para você.
                    </p>
                  </div>
                  <button
                    onClick={() =>
