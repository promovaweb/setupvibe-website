    ...
    <div className="w-full bg-background min-h-screen">
      ...
      <section className="relative pt-24 pb-16 md:pt-32 md:pb-24 overflow-hidden">
        <div className="absolute inset-0 -z-10">
          <div className="absolute top-0 left-1/4 w-96 h-96 bg-purple-500/10 rounded-full mix-blend-multiply filter blur-3xl opacity-50 animate-blob" />
          <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-blue-500/10 rounded-full mix-blend-multiply filter blur-3xl opacity-50 animate-blob animation-delay-2000" />
        </div>
        ...
        <div className="container mx-auto px-4 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <div className="inline-flex items-center gap-2 rounded-full border bg-background/80 backdrop-blur-sm px-4 py-1.5 text-sm mb-6 shadow-sm">
              ...
              <span className="text-muted-foreground font-semibold">Versão 2024.1 Disponível</span>
            </div>
          </motion.div>
          <motion.h1 
            ...
            className="text-4xl md:text-6xl font-bold tracking-tight mb-6 max-w-4xl mx-auto leading-[1.1]"
          >
            Sua máquina pronta para <br />
            <span className="bg-gradient-to-r from-purple-600 to-blue-600 dark:from-purple-400 dark:to-blue-400 bg-clip-text text-transparent">
              Vibe Coding em minutos
            </span>
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 20 }} 
          ...
          >
            Um comando cirúrgico. Zero configuração manual. <br className="hidden md:block" />
            Tudo o que você precisa para criar com IA, do terminal ao deploy.
          </motion.p>
        </div>
      </section>
