...
export function PromovawebCTA() {
  return (
    <section className="py-0 relative overflow-hidden bg-slate-950 w-full">
      {/* Dynamic Background Gradients (Brand Colors) */}
      <div className="absolute top-0 left-1/4 w-[800px] h-[600px] bg-blue-600/10 rounded-full blur-[140px] animate-pulse"></div>
      <div className="absolute bottom-0 right-1/4 w-[800px] h-[600px] bg-purple-600/10 rounded-full blur-[140px] animate-pulse" style={{ animationDelay: '3s' }}></div>

      <div className="relative z-10 w-full">
        <div className="relative group w-full">
          
          {/* Main Full-Width Container */}
          <div className="relative overflow-hidden bg-slate-900/40 backdrop-blur-3xl border-y border-slate-800 shadow-2xl py-20 md:py-28 lg:py-32">
            
            {/* Ambient Light Effects - Full Width Lines */}
                ...
                <div className="lg:col-span-7 space-y-10">
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-lg md:text-xl text-slate-400 font-medium leading-relaxed max-w-2xl">
                      Entre para a elite da <strong className="text-white font-bold">Automação e Vibe Coding</strong>. 
                    ...
                    {[
                      ...
                      <div key={idx} className={`flex items-start gap-4 p-4 rounded-2xl ${item.bg} border border-white/5 transition-all hover:border-white/10 group/item`}>
                        ...
                        <div>
                          ...
                          <div className="text-xs text-slate-500 font-bold uppercase tracking-wider">{item.sub}</div>
                        </div>
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="pt-6 flex flex-col sm:flex-row gap-6 items-center">
                    <a 
                      ...
                      className="group/btn relative w-full sm:w-auto inline-flex items-center justify-center gap-3 h-12 px-8 rounded-xl bg-blue-600 text-white font-bold text-base overflow-hidden transition-all hover:bg-blue-500 hover:scale-[1.03] active:scale-95 shadow-[0_0_20px_rgba(37,99,235,0.3)]"
                    >
                      <span className="relative z-10 uppercase tracking-wide">QUERO ME INSCREVER AGORA</span>
                      <ArrowRight className="relative z-10 h-5 w-5 group-hover/btn:translate-x-1.5 transition-transform" />
                    </a>
          ...
          {/* Subtle Outer Neon Glow for the entire strip */}
